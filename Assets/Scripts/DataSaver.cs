/*
    Original code comes from https://github.com/FellowshipOfTheGame/FinalInferno
    Author: kori4r2
*/
...
public class DataSaver<T> where T : new()
{
    ...
    public DataSaver(string fileName, bool encrypt, bool saveHistory = false){
        ...
        if(saveHistory){
            ...
            this.config = System.IO.Path.Combine( System.IO.Path.Combine(Application.persistentDataPath, fileName), this.config);
            #endif
